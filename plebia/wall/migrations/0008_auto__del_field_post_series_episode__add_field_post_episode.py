...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.series_episode'
        db.delete_column('wall_post', 'series_episode_id')

        # Adding field 'Post.episode'
        db.add_column('wall_post', 'episode', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wall.SeriesSeasonEpisode']), keep_default=False)
