...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeriesSeasonEpisode.next_episode'
        db.add_column('wall_seriesseasonepisode', 'next_episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wall.SeriesSeasonEpisode'], null=True, blank=True), keep_default=False)

        # Adding field 'Series.url'
        db.add_column('wall_series', 'url', self.gf('django.db.models.fields.CharField')(default=1, max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeriesSeasonEpisode.next_episode'
        db.delete_column('wall_seriesseasonepisode', 'next_episode_id')
