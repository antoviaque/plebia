...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('wall_episode', 'overview', self.gf('django.db.models.fields.CharField')(max_length=5000))
    ...
    models = {
        'wall.episode': {
            ...
            'overview': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'blank': 'True'}),
