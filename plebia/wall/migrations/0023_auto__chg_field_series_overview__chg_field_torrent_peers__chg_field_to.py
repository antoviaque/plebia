...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Series.overview'
        db.alter_column('wall_series', 'overview', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Torrent.peers'
        db.alter_column('wall_torrent', 'peers', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Torrent.seeds'
        db.alter_column('wall_torrent', 'seeds', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Series.overview'
        db.alter_column('wall_series', 'overview', self.gf('django.db.models.fields.CharField')(max_length=500))

        # User chose to not deal with backwards NULL issues for 'Torrent.peers'
        raise RuntimeError("Cannot reverse this migration. 'Torrent.peers' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Torrent.seeds'
        raise RuntimeError("Cannot reverse this migration. 'Torrent.seeds' and its values cannot be restored.")
