...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Torrent.has_metadata'
        db.add_column('wall_torrent', 'has_metadata', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Torrent.has_metadata'
        db.delete_column('wall_torrent', 'has_metadata')
