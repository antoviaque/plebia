...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Torrent.tracker_url'
        db.delete_column('wall_torrent', 'tracker_url')

        # Adding field 'Torrent.tracker_url_list'
        db.add_column('wall_torrent', 'tracker_url_list', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Torrent.tracker_url'
        db.add_column('wall_torrent', 'tracker_url', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Deleting field 'Torrent.tracker_url_list'
        db.delete_column('wall_torrent', 'tracker_url_list')
