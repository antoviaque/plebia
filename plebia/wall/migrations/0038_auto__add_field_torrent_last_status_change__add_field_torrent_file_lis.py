...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Torrent.last_status_change'
        db.add_column('wall_torrent', 'last_status_change', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 11, 20), blank=True), keep_default=False)

        # Adding field 'Torrent.file_list'
        db.add_column('wall_torrent', 'file_list', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Torrent.last_status_change'
        db.delete_column('wall_torrent', 'last_status_change')

        # Deleting field 'Torrent.file_list'
        db.delete_column('wall_torrent', 'file_list')
    ...
    models = {
        ...
        'wall.torrent': {
            ...
            'tracker_url': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
