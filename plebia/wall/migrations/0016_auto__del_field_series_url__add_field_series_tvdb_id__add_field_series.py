...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Series.url'
        db.delete_column('wall_series', 'url')

        # Adding field 'Series.tvdb_id'
        db.add_column('wall_series', 'tvdb_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Series.imdb_id'
        db.add_column('wall_series', 'imdb_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Series.language'
        db.add_column('wall_series', 'language', self.gf('django.db.models.fields.CharField')(default='en', max_length=50), keep_default=False)

        # Adding field 'Series.overview'
        db.add_column('wall_series', 'overview', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'Series.first_aired'
        db.add_column('wall_series', 'first_aired', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Series.banner_url'
        db.add_column('wall_series', 'banner_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Series.url'
        raise RuntimeError("Cannot reverse this migration. 'Series.url' and its values cannot be restored.")

        # Deleting field 'Series.tvdb_id'
        db.delete_column('wall_series', 'tvdb_id')

        # Deleting field 'Series.imdb_id'
        db.delete_column('wall_series', 'imdb_id')

        # Deleting field 'Series.language'
        db.delete_column('wall_series', 'language')

        # Deleting field 'Series.overview'
        db.delete_column('wall_series', 'overview')

        # Deleting field 'Series.first_aired'
        db.delete_column('wall_series', 'first_aired')

        # Deleting field 'Series.banner_url'
        db.delete_column('wall_series', 'banner_url')
    ...
    models = {
        ...
        'wall.series': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imdb_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
