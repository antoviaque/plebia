...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('wall_torrent', 'eta', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Torrent.eta'
        db.alter_column('wall_torrent', 'eta', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
