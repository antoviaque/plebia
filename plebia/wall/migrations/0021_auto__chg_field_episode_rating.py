...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.rating'
        db.alter_column('wall_episode', 'rating', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Episode.rating'
        db.alter_column('wall_episode', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))
