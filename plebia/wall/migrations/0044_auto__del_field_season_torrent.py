...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Season.torrent'
        db.delete_column('wall_season', 'torrent_id')


    def backwards(self, orm):
        
        # Adding field 'Season.torrent'
        db.add_column('wall_season', 'torrent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wall.Torrent'], null=True), keep_default=False)
    ...
    models = {
        ...
        'wall.torrent': {
            ...
            'eta': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
