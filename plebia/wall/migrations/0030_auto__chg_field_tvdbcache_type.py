...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TVDBCache.type'
        db.alter_column('wall_tvdbcache', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'TVDBCache.type'
        db.alter_column('wall_tvdbcache', 'type', self.gf('django.db.models.fields.IntegerField')())
