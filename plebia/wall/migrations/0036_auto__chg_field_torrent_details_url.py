...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Torrent.details_url'
        db.alter_column('wall_torrent', 'details_url', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Torrent.details_url'
        db.alter_column('wall_torrent', 'details_url', self.gf('django.db.models.fields.CharField')(max_length=100))
