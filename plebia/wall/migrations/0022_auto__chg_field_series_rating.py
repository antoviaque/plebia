...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Series.rating'
        db.alter_column('wall_series', 'rating', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Series.rating'
        db.alter_column('wall_series', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))
