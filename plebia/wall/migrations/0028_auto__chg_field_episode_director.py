...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.director'
        db.alter_column('wall_episode', 'director', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Episode.director'
        db.alter_column('wall_episode', 'director', self.gf('django.db.models.fields.CharField')(max_length=50))
