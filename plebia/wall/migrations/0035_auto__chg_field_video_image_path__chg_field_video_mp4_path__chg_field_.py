...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.image_path'
        db.alter_column('wall_video', 'image_path', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Video.mp4_path'
        db.alter_column('wall_video', 'mp4_path', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Video.original_path'
        db.alter_column('wall_video', 'original_path', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Video.webm_path'
        db.alter_column('wall_video', 'webm_path', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Video.ogv_path'
        db.alter_column('wall_video', 'ogv_path', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Video.image_path'
        db.alter_column('wall_video', 'image_path', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Video.mp4_path'
        db.alter_column('wall_video', 'mp4_path', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Video.original_path'
        db.alter_column('wall_video', 'original_path', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Video.webm_path'
        db.alter_column('wall_video', 'webm_path', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Video.ogv_path'
        db.alter_column('wall_video', 'ogv_path', self.gf('django.db.models.fields.CharField')(max_length=200))
