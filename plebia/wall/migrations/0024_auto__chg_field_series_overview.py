...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('wall_series', 'overview', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Series.overview'
        db.alter_column('wall_series', 'overview', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))
