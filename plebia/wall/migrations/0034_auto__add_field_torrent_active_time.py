...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Torrent.active_time'
        db.add_column('wall_torrent', 'active_time', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Torrent.active_time'
        db.delete_column('wall_torrent', 'active_time')
