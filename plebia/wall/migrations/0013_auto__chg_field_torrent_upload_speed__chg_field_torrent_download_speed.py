...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Torrent.upload_speed'
        db.alter_column('wall_torrent', 'upload_speed', self.gf('django.db.models.fields.IntegerField')(max_length=20))

        # Changing field 'Torrent.download_speed'
        db.alter_column('wall_torrent', 'download_speed', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Torrent.upload_speed'
        db.alter_column('wall_torrent', 'upload_speed', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Torrent.download_speed'
        db.alter_column('wall_torrent', 'download_speed', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'wall.torrent': {
            ...
            'upload_speed': ('django.db.models.fields.IntegerField', [], {'max_length': '20', 'blank': 'True'})
        },
        'wall.video': {
