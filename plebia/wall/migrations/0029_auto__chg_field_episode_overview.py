...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.overview'
        db.alter_column('wall_episode', 'overview', self.gf('django.db.models.fields.CharField')(max_length=2000))


    def backwards(self, orm):
        
        # Changing field 'Episode.overview'
        db.alter_column('wall_episode', 'overview', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        'wall.episode': {
            ...
            'overview': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'}),
