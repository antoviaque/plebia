...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('wall_torrent', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Torrent.type'
        db.delete_column('wall_torrent', 'type')
